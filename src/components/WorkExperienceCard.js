...
export default function makeWorkExperienceCard(
  ...
  const card = parent.add([
    ...
    k.area(),
    k.outline(4, k.Color.fromHex(theme.colors.primary)), 
    k.pos(posVec2),
    k.color(k.Color.fromHex(theme.colors.cardBackground || "#0b0c15")), 
    k.opacity(0),
  ...
  const description = card.add([
    k.text(roleData.description, { font: "ibm-regular", size: 22, width: 750 }),
    k.color(k.Color.fromHex(theme.colors.text)),
    k.pos(20, 110),
    k.opacity(0),
  ]);
